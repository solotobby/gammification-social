            ...
            <div class="row justify-content-center">
                <div class="col-lg-5 align-self-center">
                    <p class="font-weight-medium text-uppercase mb-2"><i
                            class="mdi mdi-chart-bubble h2 text-primary me-1 align-middle"></i> Payment Received </p>
                    {{-- <h3 class="font-weight-semibold line-height-1_4 mb-4">We do the work you <b>stay focused</b> on
                        <b>your customers</b>.
                    </h3> --}}
                    <h3 class="title mb-3">Payment Successful</h3>

                    <p class="text-muted font-size-15 mb-4">
                       Your payment is successful. An email containing your access code will be sent to your email within the next 3 hours of this payment from support@payhankey.com with the title <strong>Access Code Mail</strong>.
                       <br>Please lookout for the email. Thank you for choosing Payhankey - The Best monetization platform!
                    </p>
