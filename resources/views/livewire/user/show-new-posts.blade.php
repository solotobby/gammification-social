            ...
            <div wire:poll.visible.420s class="block block-rounded block-bordered" id="timelines">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a class="dropdown-item"
                                        href="{{ url('post/timeline/' . $timeline->id . '/analytics') }}">
                ...
                <div class="block-content block-content-full bg-body-light">
                    ...
                    <form method="POST" wire:submit.prevent="comment">
                        <input type="text" wire:model="message" name="message" :value="old('message')"
                            class="form-control form-control-alt" placeholder="Write a comment.." required>
                    </form>
                        ...
                        @foreach ($comments as $comment)
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    <p class="mb-1">
                                        <a class="fw-semibold"
                                            href="{{ url('profile/' . $comment->user->username) }}">{{ $comment->user->name }}</a>
                                        <span
                                            class="fs-sm text-muted">{{ $comment->created_at?->shortAbsoluteDiffForHumans() }}
                                            ago</span> <br>
                                        {{ $comment->message }}
                                    </p>
                                </div>
