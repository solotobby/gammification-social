    ...
    <ul class="nav nav-tabs nav-tabs-block" role="tablist">
        <li class="nav-item">
            <button wire:click="switchTab('followers')" 
                    class="nav-link {{ $activeTab === 'followers' ? 'active' : '' }}" 
                    role="tab">
        ...
        <li class="nav-item">
            <button wire:click="switchTab('following')" 
                    class="nav-link {{ $activeTab === 'following' ? 'active' : '' }}" 
                    role="tab">
        ...
        <div class="row">
            @forelse($connections as $conn)
                @php
                    ...
                    $person = $activeTab === 'followers' ? $conn->follower : $conn->following;
                    ...
                    <div class="block block-rounded block-link-shadow text-center">
                        ...
                        <a href="{{ url('profile/'.$person->username) }}">
                            <div class="block-content block-content-full">
                                ...
                                src="{{ asset('src/assets/media/avatars/avatar13.jpg') }}"
                                     {{-- src="{{ $person->avatar ?? asset('default-avatar.png') }}"  --}}
                                     alt="{{ $person->name }}">
                            </div>
                        </a>
                        ...
                        <div class="block-content block-content-full block-content-sm bg-body-light">
                            ...
                            <p class="fs-sm fw-medium text-muted mb-0"><span>@</span><span>{{ $person->username }}</span></p>
                        </div>
