          ...
          <div class="bg-black-75">
            <div class="content content-boxed text-center">
              <div class="py-5">
                ...
                <h2 class="fs-4 fw-normal text-white-75">Go to Cretor or Influencer to monentize your account!</h2>
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="col-md-6 col-xl-4">
                    @if($activeLevel && $activeLevel->level_id == $level->id)
                        ...
                        <div class="block block-rounded block-themed text-center">
                            ...
                            <div class="block-content bg-body-light">
                            <div class="py-2">
                                <p class="h1 fw-bold mb-2">{{ getCurrencyCode() }}{{ $level->amount }}</p>
                                <p class="h6 text-muted">per month</p>
                            </div>
                            </div>
                            <div class="block-content">
                    ...
                    @else
                        <!-- Startup Plan -->
                        {{-- <a class="block block-link-pop block-rounded text-center" wire:click="upgradeLevel({{ $level->id }})"> --}}

                        {{-- <a class="block block-link-pop block-rounded text-center" href="{{ route('subscribe', ['levelId' => $level->id]) }}"> --}}

                        <div class="block block-link-pop block-rounded text-center" wire:click="upgradeLevel('{{ $level->id }}')">
