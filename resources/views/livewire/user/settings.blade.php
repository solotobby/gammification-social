        ...
        <div class="px-4 py-3 bg-body-extra-light d-flex flex-column flex-md-row align-items-center">
            <a class="d-block img-link mt-n5" href="#">
                <img class="img-avatar img-avatar128 img-avatar-thumb"
                    src="{{ auth()->user()->avatar ?? asset('src/assets/media/avatars/avatar13.jpg') }}"
                        ...
                        <form wire:submit.prevent="updateProfile">
                            ...
                            <div class="mb-4">
                                <label class="form-label">
                                    About <small class="text-muted">(40 characters max)</small>
                                </label>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="date" class="form-control" wire:model.defer="date_of_birth" max="{{ now()->subYears(13)->toDateString() }}">
                                @error('date_of_birth')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="dm-profile-edit-company"
                                    name="dm-profile-edit-company" value="{{ auth()->user()->referral_code }}"
                                    readonly>
                            </div>

                            <button wire:click="updateProfile"class="btn btn-alt-primary">
                    ...
                    <div class="col-xl-6 order-xl-0">
                        <form action="" method="POST" onsubmit="" wire:submit.prevent="updateSocial">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="dm-profile-edit-password"
                                    wire:model="facebook">
                            </div>
                            <div class="row mb-4">
                                <div class="col-12">
                                    <label class="form-label" for="dm-profile-edit-password-new">TikTok</label>
                                    <input type="text" class="form-control" id="dm-profile-edit-password-new"
                                        wire:model="tiktok">
                                </div>
                            </div>
                            <div class="row mb-4">
                                <div class="col-12">
                                    <label class="form-label"
                                        for="dm-profile-edit-password-new-confirm">Instagram</label>
                                    <input type="text" class="form-control"
                                        id="dm-profile-edit-password-new-confirm" wire:model="instagram">
                                </div>
                            </div>
                            <div class="row mb-4">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control"
                                        id="dm-profile-edit-password-new-confirm" wire:model="twitter">
                                </div>
                            </div>
                            <div class="row mb-4">
                                <div class="col-12">
                                    <label class="form-label"
                                        for="dm-profile-edit-password-new-confirm">LinkedIn</label>
                                    <input type="text" class="form-control"
                                        id="dm-profile-edit-password-new-confirm" wire:model="linkedin">
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-12">
                                    <label class="form-label"
                                        for="dm-profile-edit-password-new-confirm">Pinterest</label>
                                    <input type="text" class="form-control"
                                        id="dm-profile-edit-password-new-confirm" wire:model="pinterest">
                                </div>
                            </div>
