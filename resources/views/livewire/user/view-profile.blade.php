    ...
    <div class="rounded border overflow-hidden push">
        ...
        <div class="px-4 py-3 bg-body-extra-light d-flex flex-column flex-md-row align-items-center">
            ...
            <h2 class="fs-sm fw-medium text-muted mb-0">
                <a href="{{ url('profile/'.$user->username.'/connection') }}" class="text-muted">{{ $user->followers }} Followers</a> &bull;
                <a href="{{ url('profile/'.$user->username.'/connection') }}" class="text-muted">{{ $user->following }} Following</a> &bull;
