                ...
                <ul class="nav-main-submenu">
                  <li class="nav-main-item open">
                    ...
                    <ul class="nav-main-submenu">
                      ...
                      <li class="nav-main-item">
                        <a class="nav-main-link active" href="be_pages_generic_profile_v2.html">
        ...
        <div class="content content-full content-boxed">
          ...
          <div class="rounded border overflow-hidden push">
            ...
            <div class="px-4 py-3 bg-body-extra-light d-flex flex-column flex-md-row align-items-center">
              ...
              <div class="space-x-1">
                <a href="be_pages_generic_profile_v2_edit.html" class="btn btn-sm btn-alt-secondary space-x-1">
